    ...
    <div className="footer">
      <div className="footer-container">
        <div className="left">
          ...
          <div className="mail">
            <a href={`mailto:${process.env.REACT_APP_EMAIL}`}><h4><IoMail size={20} style={{color: 'white', marginRight:'1.5rem'}}/>rameshrajendran5555@gmail.com</h4></a>
          </div>
        </div>
        <div className="right">
          <h4>About Me</h4>
          <p>My name is Ramesh P R, I'm a Front-end Developer. I have a passion for crafting clean, efficient code that drives results. As a strong team player, I excel in collaborative environments. I'm eager to contribute my expertise to drive innovation and deliver top-notch solutions."</p>
